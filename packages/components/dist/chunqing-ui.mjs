import { openBlock, createElementBlock, createElementVNode, warn, watch, unref, inject, ref, computed, getCurrentInstance, defineComponent, mergeProps, renderSlot, useSlots, Text, normalizeClass, normalizeStyle, Fragment, createBlock, withCtx, resolveDynamicComponent, createCommentVNode, provide, reactive, toRef, createTextVNode } from "vue";
var _a;
...
const _hoisted_1$1 = ["aria-disabled", "disabled", "autofocus", "type"];
...
var Button$1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/button/src/button.vue"]]);
...
const _hoisted_1 = /* @__PURE__ */ createTextVNode("我是 ElButton");
const _sfc_main = /* @__PURE__ */ defineComponent({
  name: "button",
  setup(__props) {
    defineOptions({ name: "ea-button" });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElButton), null, {
        default: withCtx(() => [
          _hoisted_1
        ]),
        _: 1
